// src/app/admin/chat/page.tsx - ADMIN CHAT WITH CUSTOMER SELECTION
"use client";
  ...
  return (
    <div className="fixed inset-0 bg-gray-100 dark:bg-gray-900 flex overflow-hidden">
      ...
      <div className={`${showSidebar ? 'w-full md:w-80' : 'hidden md:flex md:w-80'} bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col`}>
        {/* SIDEBAR HEADER */}
        <div className="bg-blue-50 dark:bg-blue-900 p-4 border-b border-gray-200 dark:border-gray-600 flex-shrink-0">
          <div className="flex justify-between items-center mb-3">
            <div>
              <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Admin Chat</h2>
              <p className="text-sm text-gray-600 dark:text-gray-400">Support Customer</p>
            </div>
            <button
          ...
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Cari chat customer..."
              value={searchQuery}
        ...
        <div className="flex-1 overflow-y-auto">
          {filteredConversations.length === 0 ? (
            <div className="p-6 text-center text-gray-500 dark:text-gray-400">
              ...
              <p>{searchQuery ? "Tidak ada hasil" : "Belum ada chat customer"}</p>
              <p className="text-sm">{searchQuery ? "Coba kata kunci lain" : "Mulai chat dengan customer!"}</p>
            </div>
          ) : (
            filteredConversations.map((conversation) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <div className="bg-green-100 dark:bg-green-900 text-green-600 dark:text-green-400 rounded-full p-2 flex-shrink-0">
                      <User size={20} />
                    </div>
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">
                        {conversation.subject || "Chat Admin"}
                      </p>
      ...
      <div className={`${!showSidebar || selectedConversation ? 'flex' : 'hidden md:flex'} flex-1 flex-col bg-gray-50 dark:bg-gray-900`}>
        {selectedConversation ? (
            ...
            <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 p-4 flex items-center space-x-3 flex-shrink-0">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  {selectedConversationData?.subject || "Chat Admin"}
                </p>
              </div>
                      ...
                      <div className={`max-w-xs lg:max-w-md px-4 py-2 rounded-2xl shadow-sm ${
                        ...
                        <div className="flex items-center space-x-2 mb-1">
                          <span className="text-xs font-medium opacity-75">
                            {message.sender.role === "CUSTOMER" ? "Customer" : "Admin"}
                          </span>
                        </div>
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center">
              <Users size={80} className="text-blue-300 dark:text-blue-600 mx-auto mb-6" />
              <h3 className="text-xl font-medium text-gray-900 dark:text-white mb-2">
                Admin Support Center
              </h3>
              <p className="text-gray-500 dark:text-gray-400 mb-6">
                Pilih percakapan dengan customer atau mulai chat baru
              </p>
              <button
                onClick={() => setShowNewChatModal(true)}
      ...
      {showNewChatModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 w-full max-w-md shadow-2xl">
            <h3 className="text-xl font-semibold mb-6 text-gray-900 dark:text-white">Chat dengan Customer</h3>
